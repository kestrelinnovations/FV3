...
class Cmov_sym_overlay_editor : public IFvOverlayEditor
{
public:
   Cmov_sym_overlay_editor();
...
extern const GUID FVWID_Overlay_SkyView;

// Returns true if the FVWID_Overlay_SkyView overlay type is available.
namespace skyview_overlay
{
   bool IsOverlayTypeEnabled();
}
