...
//  MALLOC(box, p->num_contours * sizeof(bbox), "Bounding box creation");
  box = (bbox*) malloc(p->num_contours * sizeof(bbox));
...
//  MALLOC(o_table, subj->num_contours * clip->num_contours * sizeof(int), "overlap table creation");
  o_table = (int*) malloc(subj->num_contours * clip->num_contours * sizeof(int));
...
//  MALLOC(extended_hole, (p->num_contours + 1) * sizeof(int), "contour hole addition");
	extended_hole = (int*) malloc((p->num_contours + 1) * sizeof(int));

  /* Create an extended contour array */
//  MALLOC(extended_contour, (p->num_contours + 1) * sizeof(gpc_vertex_list), "contour addition");
  extended_contour = (gpc_vertex_list*) malloc((p->num_contours + 1) * sizeof(gpc_vertex_list));
  if (!extended_contour)
  {
	  AfxMessageBox("Error allocating memory for extended_contour");
	  return;
  }
...
//  MALLOC(extended_contour[c].vertex, new_contour->num_vertices * sizeof(gpc_vertex), "contour addition");
...
//  MALLOC(sbt, sbt_entries * sizeof(double), "sbt creation");
  ...
  {
//    MALLOC(result->hole, result->num_contours * sizeof(int), "hole flag table creation");
	result->hole = (int*) malloc(result->num_contours * sizeof(int));

//    MALLOC(result->contour, result->num_contours * sizeof(gpc_vertex_list), "contour creation");
	result->contour = (gpc_vertex_list*) malloc(result->num_contours * sizeof(gpc_vertex_list));
...
//        MALLOC(result->contour[c].vertex, result->contour[c].num_vertices * sizeof(gpc_vertex), "vertex creation");
		result->contour[c].vertex = (gpc_vertex*) malloc(result->contour[c].num_vertices * sizeof(gpc_vertex));
...
//  MALLOC(sbt, sbt_entries * sizeof(double), "sbt creation");
  ...
  {
//    MALLOC(result->strip, result->num_strips * sizeof(gpc_vertex_list), "tristrip list creation");
	result->strip = (gpc_vertex_list*) malloc(result->num_strips * sizeof(gpc_vertex_list));
...
//        MALLOC(result->strip[s].vertex, tn->active * sizeof(gpc_vertex), "tristrip creation");
		result->strip[s].vertex = (gpc_vertex*) malloc(tn->active * sizeof(gpc_vertex));
